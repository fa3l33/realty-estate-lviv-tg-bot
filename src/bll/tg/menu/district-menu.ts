...
export class DistrictMenu extends Menu implements IMenu {
  ...
  private readonly CHECKED_VOSTOCHNIY = addChecked(Constants.SUB_DISTRICT.VOSTOCHNIY);
  private readonly CHECKED_KINDIYKA = addChecked(Constants.SUB_DISTRICT.KINDIYKA);
  private readonly CHECKED_STEKLOTARA = addChecked(Constants.SUB_DISTRICT.STEKLOTARA);
  private readonly CHECKED_TEKSTILNIY = addChecked(Constants.SUB_DISTRICT.TEKSTILNIY);
  private readonly CHECKED_HBK = addChecked(Constants.SUB_DISTRICT.HBK);
  private readonly CHECKED_ZHILMASIV = addChecked(Constants.SUB_DISTRICT.ZHILMASIV);
  private readonly CHECKED_ZHILPOSELOK = addChecked(Constants.SUB_DISTRICT.ZHILPOSELOK);
  private readonly CHECKED_ZABALKA = addChecked(Constants.SUB_DISTRICT.ZABALKA);
  private readonly CHECKED_NEFTEGAVAN = addChecked(Constants.SUB_DISTRICT.NEFTEGAVAN);
  ...
  private readonly CHECKED_PORT_ELEVATOR = addChecked(Constants.SUB_DISTRICT.PORT_ELEVATOR);
  private readonly CHECKED_PRIVOKZALNIY = addChecked(Constants.SUB_DISTRICT.PRIVOKZALNIY);
  private readonly CHECKED_SHUMSKIY = addChecked(Constants.SUB_DISTRICT.SHUMSKIY);
  private readonly CHECKED_MELNIZA = addChecked(Constants.SUB_DISTRICT.MELNIZA);
  private readonly CHECKED_SEVERNIY = addChecked(Constants.SUB_DISTRICT.SEVERNIY);
  private readonly CHECKED_CENTR = addChecked(Constants.SUB_DISTRICT.CENTR);
  private readonly CHECKED_TAVRICHESK = addChecked(Constants.SUB_DISTRICT.TAVRICHESK);
